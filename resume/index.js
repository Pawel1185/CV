...
const location = document.querySelector(".address_svg");
location.innerHTML = `<?xml version="1.0" encoding="iso-8859-1"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
cross.innerHTML = `<?xml version="1.0" encoding="iso-8859-1"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
nextBtn.addEventListener('click', function () {
    ...
    slider.style.transform = 'translate(-1.92%)'
})
...
slider.addEventListener('transitionend', function() {
    ...
    setTimeout(function() {
        slider.style.transition = 'ease-in-out 0.2s';
    })
})
